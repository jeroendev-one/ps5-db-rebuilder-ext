...
def get_game_info_by_id(GameID) :
	if(GameID not in info) :
		...
		info[GameID].sfo = sfo
		info[GameID].size = ftp.size("/mnt/ext1/user/app/%s/app.pkg" % GameID)
...
for tbl in tables :
	...
	for tmp_GameID in list_id :
		...
		if(cusa.is_usable == True) :
			sql_list.append("""("%s", "%s", "%s", "/user/appmeta/external/%s", "2018-07-27 15:06:46.822", "0", "0", "5", "1", "100", "0", "151", "5", "1", "gd", "0", "0", "0", "0", NULL, NULL, NULL, "%d", "2018-07-27 15:06:46.802", "0", "game", NULL, "0", "0", NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "0", NULL, NULL, NULL, NULL, NULL, "0", "0", NULL, "2018-07-27 15:06:46.757")"""
